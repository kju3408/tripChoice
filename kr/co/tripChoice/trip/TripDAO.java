...
public class TripDAO {
	...
	public ArrayList<TripDTO> list(int trip_no) {
		try {
			...
			sql.append(" SELECT trip_code,trip_area,trip_name,trip_content,trip_cost1,trip_cost2,trip_cost3,trip_possible,trip_airpcost,trip_bedcost,trip_situation ");
			sql.append(" FROM trip");
			sql.append(" WHERE trip_no =? ");
			sql.append(" ORDER BY trip_no desc ");
