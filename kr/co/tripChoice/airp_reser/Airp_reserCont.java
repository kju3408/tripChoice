...
public class Airp_reserCont {
	...
	public Airp_reserCont() {
	 ...
	 public ModelAndView duplecateSeat(String ta_code, String tar_seat) { // String tar_seat는 원래 seatcol
		 ModelAndView mav = new ModelAndView();
		 mav.setViewName("t_airp/seat");
		 //request 공간에 자료 올리기
		 mav.addObject("root", Utility.getRoot());// /tripChoice
		 mav.addObject("cnt", dao.duplecateSeat(ta_code, tar_seat));//dao에서 가져온 값을 request영역에 올리기
		 return mav;
	 }*/
