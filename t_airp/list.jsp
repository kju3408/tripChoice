	...
	<table class="text-center" style="width:60%; height: 100px; margin: auto; text-align: center;">
		...
		<c:forEach var="dto" items="${list}">
			<tr class="airp">
				...
				<td>${dto.ta_pax}</a></td>
				<td><input type="button" value="예약" onclick="location.href='reser.do?ta_code=${dto.ta_code}'">
				</td>
				<td><input type="button" value="삭제" onclick="location.href='delete.do?ta_code=${dto.ta_code}'">
				</td>
