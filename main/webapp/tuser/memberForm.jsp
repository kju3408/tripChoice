...
<tr>
    <th>*이름</th>
    <td style="text-align: left"><input type="text" name="tu_name" id="tu_name" size="15" maxlength="20" required></td>
</tr>
<tr>
    <th>*이메일</th>
    <td style="text-align: left">
...
<tr>
    <th>전화번호</th>
    <td style="text-align: left"><input type="text" name="tu_phone" id="tu_phone" size="15"></td>
</tr>
<tr>
    <th>우편번호</th>
    <td style="text-align: left">
...
<tr>  
  <th>주소</th>
  <td style="text-align: left"><input type="text" name="tu_address" id="tu_address" size="45" readonly></td>
</tr>
<tr>  
  <th>나머지주소</th>
  <td style="text-align: left"><input type="text" name="tu_address2" id="tu_address2" size="45"></td>
</tr>
<tr>
    <td colspan="2">
